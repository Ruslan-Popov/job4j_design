...
public class SimpleQueue<T> {
     ...
     * В1 начале метода в in хранятся значения, out - пустой стек.
     * Из in перекладывается все в out в обратном порядке.
     * В in добавляется значение, потом методом push опять в обратном
     * порядке добавляются все значения, и добавленное в in значение
     * оказывается в конце.
